          ...
          <div className="animate-fade-in-up animation-delay-100 grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-medium tracking-wide text-muted-foreground uppercase">
                Games <span className="text-destructive">*</span>{' '}
              ...
              {errors.gameIds && (
                <p className="text-sm text-destructive">{errors.gameIds}</p>
              )}
            </div>
          </div>
          ...
          <div className="animate-fade-in-up animation-delay-200 grid grid-cols-4 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={scheduleType}
                onValueChange={(v) =>
                  setScheduleType(v as GatheringFormData['scheduleType'])
                }
              >
